...
import { getRatingSupportServiceById } from "../../services/adminService"
  ...
  useEffect(() => {
    const fetchSchedulingDetail = async () => {
      ...
      if (res.success) {
        ...
        // Nếu lịch hỗ trợ đã hoàn thành, lấy đánh giá
    ...
    const fetchRating = async () => {
      ...
      try {
        const res = await getRatingSupportServiceById(id)
        if (res?.success) {
          setRating(res.data)
        }
      } catch (err) {
        // Không có đánh giá hoặc lỗi thì bỏ qua
        console.log("Chưa có đánh giá cho lịch hỗ trợ này")
      } finally {
  ...
  return (
    <div className="min-h-screen  py-8 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        {/* ===== ĐÁNH GIÁ ===== */}
        {schedulingDetail.status === 'completed' && (
          <div className="mt-10 bg-white rounded-2xl shadow-md hover:shadow-lg transition-shadow p-8 border border-gray-100">
            ...
            {loadingRating ? (
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  <img
                    src={rating.reviewer?.avatar || defaultAvatar}
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500">
                      Đánh giá vào: {rating.ratedAt ? new Date(rating.ratedAt).toLocaleDateString("vi-VN") : "N/A"}
                    </p>
                  </div>
                </div>
                ...
                {/* Người hỗ trợ được đánh giá */}
                {rating.reviewee && (
                  <div className="pt-4 border-t border-gray-200">
                    <p className="text-sm text-gray-600 mb-2">Người hỗ trợ được đánh giá:</p>
                    <div className="flex items-center gap-3">
                      <img
                        src={rating.reviewee?.avatar || defaultAvatar}
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-600 text-lg">
                  Chưa có đánh giá cho lịch hỗ trợ này
                </p>
