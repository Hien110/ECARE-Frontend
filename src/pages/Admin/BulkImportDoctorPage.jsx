...
const BulkImportDoctorPage = () => {
  ...
  const handleImport = async () => {
    ...
    setImportResults(null);
    try {
      const response = await adminService.bulkImportDoctors(selectedFile);
      setImportResults(response.data);
      setMessage(response.message || "Import thành công");
      setSelectedFile(null);
      document.getElementById('file-input-doctor').value = '';
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Thêm bác sĩ bằng Excel</h1>
            <p className="text-gray-600">Tạo nhiều tài khoản bác sĩ cùng lúc từ file Excel</p>
          </div>
          <button
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="mb-8">
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
              <label htmlFor="file-input-doctor" className="cursor-pointer">
...
export default BulkImportDoctorPage;
